...
// classes on the fly.
package final class AudioEngineController: ObservableObject {
    ...
    package weak var state: AppState?
    ...
    package func playWrongButtonBeep() {
    ...
    package func playMessageReceivedDoot() {
    ...
    // another error sound.
    package func playTransmissionEndSound() {
    ...
    // energy.
    package func playLotterySetupChime() {
    ...
    package func playLotteryFinalTick() {
    ...
    // diagnosis lands).
    package func playLotteryRevealFanfare() {
    ...
    // clean "ta-da!" moment.
    package func playLotteryPrizeJingle() {
    ...
    package func speakIncoming(_ text: String) {
    ...
    package func speakOutgoing(_ text: String) {
    ...
    // syllable.
    package func speakReply(_ text: String) {
    ...
    package func selectDrumKit(named name: String) {
    ...
    package func selectPadSound(named name: String) {
    ...
    package func selectBassSound(named name: String) {
    ...
    package func trigger(_ event: NoteEvent) {
    ...
    package func stopAllPadAndBass() {
        let steps = 8
