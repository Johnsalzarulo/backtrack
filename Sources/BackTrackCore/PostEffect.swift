...
package enum PostEffect: String {
    case none
    case glitch
    case tracking
    case chroma
    ...
    package static let allCases: [PostEffect] = [.none, .glitch, .tracking, .chroma]
}
...
package enum PostEffectParser {
    package static func parse(_ raw: String?, context: String) throws -> PostEffect? {
...
package struct PostEffectParseError: Error, CustomStringConvertible {
