...
package enum SongLoader {
    ...
    package static func save(_ song: Song) throws {
    ...
    package static func parseTheme(_ raw: String?, context: String) throws -> VisualTheme? {
...
package struct SongValidationError: Error, CustomStringConvertible {
